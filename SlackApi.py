...
def get_all_channels():
    ...
    try:
        ...
        print("frali", traceback.format_exc())
                    ...
                    if key in data_to_retrieve:
                        if key == "thread_ts":
                            ...
                            try:
                                ...
                                """range starting from 1 to skip the first 
                                element because its the parent
                                """
                                for i in range(1, l):
                                    for key, value in \
                                            json_replies["messages"][
                                                i].items():
                                        if key in data_to_retrieve:
...
if __name__ == "__main__":
    ...
    while True:
        ...
        # slowing the script down to stay under 20 requests per minute
        sleep(1)
